...
public class EditFriendsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// allows you to select multiple friends. keep in mind
	...
	private void getUsersFromParse() {
		...
		query.findInBackground(new FindCallback<ParseUser>() {
			...
			public void done(List<ParseUser> users, ParseException e) {
				...
				if (e == null) {
					ParseObject.pinAllInBackground(ParseConstants.PIN_ALL_USERS, users, new SaveCallback() {
						
						@Override
						public void done(ParseException e) {
							if(e == null){
								Log.i(TAG, "All users have been pinned.");
							}
							else {
								Log.e(TAG, "error while pinning");
							}
	...
	private void addFriendCheckmarks() {
		...
		mFriendRelations.getQuery().findInBackground(
